<?php 
	...
	if (isset($_POST['tambah'])) {
		...
		$alamat = $_POST['alamat'];
		$jk = $_POST['jk'];
		$simpan = mysqli_query($konek,"INSERT INTO mahasiswa SET nim='$nim',id_mhs='',nama='$nama',agama='$agama',jenis_kelamin='$jk',jurusan='$jurusan','asal_sekolah'=$asal,alamat='$alamat' ");
		if ($simpan) {
			# code...
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<div class="form-check">
							<input type="radio" name="jk" class="form-check-input" value="L">
							<label class="form-check-label">Laki - Laki</label>
						</div>
						<div class="form-check">
							<input type="radio" name="jk" class="form-check-input" value="P">
