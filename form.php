...
<body>
	...
	<?php 
		...
		if (isset($_POST['tambah'])) {
			...
			if (empty($nama)) {
				# code...
				$namaErr = "<p style='color:red'>Tolong Masukkan Nama.<br></p>";
			}
			if (empty($tempat)) {
				# code...
				$tempatErr = "<p style='color:red'>Tolong Masukkan Tempat Lahir.<br></p>";
			}
			if (empty($tgl)) {
				# code...
				$tglErr = "<p style='color:red'>Tolong Masukkan Tanggal Lahir.<br></p>";
			}
			if (empty($_POST['jk'])) {
				# code...
				$jkErr = "<p style='color:red'>Tolong Masukkan Jenis Kelamin.<br></p>";
			}else{
				$jk = $_POST['jk'];	
			}
			if (empty($alamat)) {
				# code..
				$alamatErr = "<p style='color:red'>Tolong Masukkan Alamat.<br></p>";
			}
		}
	 ?>
	<div class="container">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<div class="form-check">
							<input type="radio" name="jk" class="form-check-input" <?php if (isset($jk) && $jk=="Laki - Laki") echo "checked";?> value="Laki - Laki">
							<label class="form-check-label">Laki - Laki</label>
						</div>
						<div class="form-check">
							<input type="radio" name="jk" class="form-check-input"  <?php if (isset($jk) && $jk=="Perempuan") echo "checked";?> value="Perempuan">
		...
		<div class="alert alert-success">
			...
			<hr>
			<?php 
				if (isset($_POST['tambah']) && !empty($nama) && !empty($_POST['jk']) && !empty($tempat) && !empty($alamat)) {
			?>
					<div class="form-group row" autocomplete="off">
						<div class="col-sm-12">
							<textarea class="form-control js-auto-size" rows="1" readonly >Nama : <?php echo $nama; ?>&#10;Tempat : <?php echo $tempat; ?>&#10;Tanggal Lahir : <?php echo $tgl; ?>&#10;Jenis Kelamin : <?php echo $jk; ?>&#10;Alamat : <?php echo $alamat; ?>
							</textarea>
						</div>
					</div>
			<?php
